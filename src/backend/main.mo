...
actor {
  ...
  public shared ({ caller }) func createCategory(category : Category) : async () {
    ...
    if (data.categories.containsKey(category.id)) {
      Runtime.trap("Category with id " # category.id # " already exists");
    };
  ...
  public shared ({ caller }) func updateCategory(category : Category) : async () {
    ...
    if (not data.categories.containsKey(category.id)) {
      Runtime.trap("Category with id " # category.id # " does not exist");
    };
  ...
  public shared ({ caller }) func deleteCategory(categoryId : Text) : async () {
    ...
    if (not data.categories.containsKey(categoryId)) {
      Runtime.trap("Category with id " # categoryId # " does not exist");
    };
